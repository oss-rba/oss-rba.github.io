 ...
 * @apiParam {string(20)}    	AKTA.jangka_waktu	            Jangka Waktu (format date : YYYY-MM- DD)
 * @apiParam {string(2)}    	AKTA.status_badan_hukum	        Status Badan Hukum (* Lihat Lampiran 12)
 * @apiParam {string(2)}    	AKTA.status_penanaman_modal	    Status Penanaman Modal (* Lihat Lampiran 1)
 * @apiParam {string(15)}    	AKTA.npwp_perseroan	    NPWP Perseroan
 * @apiParam {string(255)}    	AKTA.nama_perseroan	    Nama Perseroan
 * @apiParam {string(255)}    	AKTA.nama_singkatan	    Nama Singkatan Perseroan
 * @apiParam {string(2)}    	AKTA.jenis_perseroan	    Jenis Perseroan (* Lihat Lampiran 2)
 * @apiParam {string(10)}    	AKTA.status_perseroan	    Jenis Perusahaan Terbuka atau Tertutup
 * @apiParam {string(255)}    	AKTA.alamat_perseroan	    alamat_perseroan
 * @apiParam {string(7)}    	AKTA.rt_rw_perseroan	    rt_rw_perseroan
 * @apiParam {string(50)}    	AKTA.kelurahan_perseroan	    kelurahan_perseroan
 * @apiParam {string(10)}    	AKTA.perseroan_daerah_id	    ID Daerah Perseroan (* Menggunakan Kodefikasi yang diterbitkan oleh Kemendagri - Permendagri No 72 Tahun 2019 : https://www.kemendagri.go.id/files/2020/PMDN 72 TH 2019+lampiran.pdf)
 * @apiParam {string(5)}    	AKTA.kode_pos_perseroan	    kode_pos_perseroan
 * @apiParam {string(20)}    	AKTA.nomor_telpon_perseroan	    nomor_telpon_perseroan
 * @apiParam {string(100)}    	AKTA.email_perusahaan	    email_perusahaan
 * @apiParam {string(20)}    	AKTA.dalam_bentuk_uang	    Modal Dalam Bentuk Uang (Valuta : IDR)
 * @apiParam {string(50000)}    	AKTA.dalam_bentuk_lain	    Modal Dalam Bentuk Lainnya
 * @apiParam {number(20)}    	AKTA.total_modal_dasar	    Total Modal Dasar (Valuta : IDR)
 * @apiParam {number(20)}    	AKTA.total_modal_ditempatkan	        Total Modal Ditempatkan (Valuta : IDR)
 * @apiParam {object[]}    	AKTA.data_kbli	                        data_kbli
 * @apiParam {string(1024)}    	AKTA.data_kbli.kbli	                    Maksud & Tujuan KBLI
 * @apiParam {string(1024)}   	AKTA.data_kbli.uraian_usaha	            uraian_usaha
 * @apiParam {object[]}    	AKTA.pemegang_saham	                    Detail pemegang saham
 * @apiParam {string(2)}    	AKTA.pemegang_saham.jenis_pemegang_saham	    Jenis Pemegang Saham (* Lihat Lampiran 13)
 * @apiParam {string(1)}    	AKTA.pemegang_saham.flag_asing	                Asal Pemegang Saham dari Dalam Negeri/Luar Negeri (Value : Y = asing; N = Bukan Asing)
 * @apiParam {string(20)}    	AKTA.pemegang_saham.klasifikasi_saham_pemegang	    klasifikasi_saham_pemegang
 * @apiParam {string(50)}    	AKTA.pemegang_saham.jum_lbr_saham_pemegang	    jum_lbr_saham_pemegang
 * @apiParam {number(20)}    	AKTA.pemegang_saham.total_modal_pemegang	    Total Modal Pemegang Saham (Valuta : IDR)
 * @apiParam {string(50)}    	AKTA.pemegang_saham.jabatan_pemegang_saham	    jabatan_pemegang_saham
 * @apiParam {string(500)}    	AKTA.pemegang_saham.nama_pemegang_saham	    nama_pemegang_saham
 * @apiParam {string(2)}    	AKTA.pemegang_saham.jns_identitas_pemegang_saham	    Jenis Identitas Pemegang Saham (* Lihat Lampiran 4)
 * @apiParam {string(100)}    	AKTA.pemegang_saham.no_identitas_pemegang_saham	    no_identitas_pemegang_saham
 * @apiParam {string(10)}    	AKTA.pemegang_saham.valid_identitas_pemegang_saham	    Valid / Masa Berlaku Pemegang Saham(Format Date : YYYY-MM-DD)
 * @apiParam {string(50)}    	AKTA.pemegang_saham.pengendali_pemegang_saham	    Nama Pengendali Pemegang Saham
 * @apiParam {string(15)}    	AKTA.pemegang_saham.npwp_pemegang_saham	    npwp_pemegang_saham
 * @apiParam {string(1024)}    	AKTA.pemegang_saham.alamat_pemegang_saham	    alamat_pemegang_saham
 * @apiParam {string(25)}    	AKTA.pemegang_saham.fax_pemegang_saham	    fax_pemegang_saham
 * @apiParam {string(100)}    	AKTA.pemegang_saham.email_pemegang_saham	    email_pemegang_saham
 * @apiParam {object[]}    	AKTA.penanggung_jwb	                            Detail penanggung jawab
 * @apiParam {string(1)}    	AKTA.penanggung_jwb.flag_asing	    Asal Penanggung Jawab dari Dalam Negeri / Luar Negeri (Value : Y = asing; N = Bukan Asing)
 * @apiParam {string(500)}    	AKTA.penanggung_jwb.nama_penanggung_jwb	    nama_penanggung_jwb
 * @apiParam {string(250)}    	AKTA.penanggung_jwb.jabatan_penanggung_jwb	    jabatan_penanggung_jwb
 * @apiParam {string(2)}    	AKTA.penanggung_jwb.kebangsaan_penanggung_jwb	    Kebangsaan Penanggung Jawab (* Lihat Lampiran 6)
 * @apiParam {string(2)}    	AKTA.penanggung_jwb.jenis_identitas_penanggung_jwb	    Jenis Identitas Penganggung Jawab (* Lihat Lampiran 4)
 * @apiParam {string(20)}    	AKTA.penanggung_jwb.no_identitas_penanggung_jwb	    Nomor Identitas Penanggung Jawab
 * @apiParam {string(2)}    	AKTA.penanggung_jwb.negara_asal_penanggung_jwb	    Negara Asal Penanggung Jawab (* Sumber Kodefikasi Negara Mengikuti Standar Unedifact : http://www.unece.org/cefact/locode/se rvice/location )
 * @apiParam {string(25)}    	AKTA.penanggung_jwb.no_paspor_penanggung_jwb	    no_paspor_penanggung_jwb
 * @apiParam {string(15)}    	AKTA.penanggung_jwb.npwp_penanggung_jwb	    npwp_penanggung_jwb
 * @apiParam {string(1024)}    	AKTA.penanggung_jwb.alamat_penanggung_jwb	    alamat_penanggung_jwb
 * @apiParam {string(50)}    	AKTA.penanggung_jwb.jalan_penanggung_jwb	    jalan_penanggung_jwb
 * @apiParam {string(10)}    	AKTA.penanggung_jwb.blok_penanggung_jwb	    blok_penanggung_jwb
 * @apiParam {string(10)}    	AKTA.penanggung_jwb.no_penanggung_jwb	    no_penanggung_jwb
 * @apiParam {string(255)}    	AKTA.penanggung_jwb.rt_rw_penanggung_jwb	    rt_rw_penanggung_jwb
 * @apiParam {string(255)}    	AKTA.penanggung_jwb.kelurahan_penanggung_jwb	    kelurahan_penanggung_jwb
 * @apiParam {string(10)}    	AKTA.penanggung_jwb.daerah_id_penanggung_jwb	    ID Daerah Penanggung Jawab (* Menggunakan Kodefikasi yang diterbitkan oleh Kemendagri - Permendagri No 72 Tahun 2019 : https://www.kemendagri.go.id/files/2020/PMDN 72 TH 2019+lampiran.pdf)
 * @apiParam {string(5)}    	AKTA.penanggung_jwb.kode_pos_penanggung_jwb	    kode_pos_penanggung_jwb
 * @apiParam {string(50)}    	AKTA.penanggung_jwb.no_telp_penanggung_jwb	    no_telp_penanggung_jwb
 * @apiParam {string(50)}    	AKTA.penanggung_jwb.no_hp_penanggung_jwb	    no_hp_penanggung_jwb
 * @apiParam {string(50)}    	AKTA.penanggung_jwb.no_fax_penanggung_jwb	    no_fax_penanggung_jwb
 * @apiParam {string(100)}    	AKTA.penanggung_jwb.email_penanggung_jwb	    email_penanggung_jwb
 * @apiParam {string(100)}    	AKTA.no_pengesahan	    Nomor Pengesahan Akta Dari Kumham
 * @apiParam {string(10)}    	AKTA.tgl_pengesahan	    Tanggal Pengesahan Akta Dari Kumham(format date : YYYY-MM-DD)
 * @apiParam {string(100)}    	AKTA.no_akta_lama	    Nomor Akta Lama Sebelum Perubahan
 * @apiParam {string(10)}    	AKTA.tgl_akta_lama	    Tanggal Akta Lama Sebelum Perubahan(format date : YYYY-MM-DD)
 * @apiParam {string(100)}    	AKTA.no_pengesahan_lama	    Nomor Pengesahan Akta Lama Sebelum Perubahan Dari Kumham
 * @apiParam {string(10)}    	AKTA.tgl_pengesahan_lama	    Tanggal Pengesahan Akta Lama Sebelum Perubahan Dari Kumham (format date : YYYY-MM-DD)
 * @apiParam {object[]}    	AKTA.legalitas	    Data legalitas
 * @apiParam {string(2)}    	AKTA.legalitas.jenis_akta	    Jenis Akta Perusahaan (* Lihat Lampiran 7)
 * @apiParam {string(100)}    	AKTA.legalitas.no_akta	    Nomor Akta Perusahaan
 * @apiParam {string(10)}    	AKTA.legalitas.tgl_akta	    Tanggal Akta Perusahaan (format date : YYYY-MM-DD)
 * @apiParam {string(100)}    	AKTA.legalitas.alamat_notaris	    alamat_notaris
 * @apiParam {string(255)}    	AKTA.legalitas.nama_notaris	    nama_notaris
 * @apiParam {string(100)}    	AKTA.legalitas.telepon_notaris	    telepon_notaris
