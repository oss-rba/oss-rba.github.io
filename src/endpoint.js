 ...
 * @apiSuccess (200) {string(2){2}} [responfetchNIB.dataNIB.data_perusahaan.data_pemegang_saham.jns_identitas_pemegang_saham]	
 * Jenis Identitas Pemegang Saham (* Lihat Lampiran 4)
 ...
 * @apiSuccess (200) {Object[]} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab] Data Penanggung Jawab		
 * @apiSuccess (200) {string(1){1}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.flag_asing]
 * Asal penanggung jawab dari Dalam Negeri / Luar Negeri (Value : Y = asing, N = Bukan Asing)		
 * @apiSuccess (200) {string(2){2}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.jns_identitas_penanggung_jwb] Jenis idetitas penanggung jawab
 * @apiSuccess (200) {string(100){100}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.no_identitas_penanggung_jwb] Nomor Identitas Penanggung Jawab
 * @apiSuccess (200) {string(500){500}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.nama_penanggung_jwb] Nama Penanggung Jawab
 * @apiSuccess (200) {string(250){250}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.jabatan_penanggung_jwb] Jabatan Penanggung Jawab
 * @apiSuccess (200) {string(2){2}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.negara_asal_penanggung_jwb] Negara Asal Penanggung Jawab		
 * @apiSuccess (200) {string(15){15}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.npwp_penanggung_jwb] NPWP Penanggung Jawab		
 * @apiSuccess (200) {string(1024){1024}} [responfetchNIB.dataNIB.data_perusahaan.data_penanggung_jawab.alamat_penanggung_jwb]	Alamat Penanggung Jawab
 * @apiSuccess (200) {Object} [responfetchNIB.dataNIB.data_perusahaan.data_rptka] Data RPTKA
 * @apiSuccess (200) {string(2){2}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.jenis_rptka]	Jenis Flag RPTKA *( 01 : Baru, 02: Perubahan)
 * @apiSuccess (200) {string(20){20}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.no_rptka] No Bacode RPTKA
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_awal] Masa Berlaku Dari Tanggal (format date : YYYY-MM-DD)
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_akhir]	Masa Berlaku Sampai Tanggal (format date : YYYY-MM- DD)
 * @apiSuccess (200) {number(20.2){20}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_gaji] Gaji Tenaga Asing
 * @apiSuccess (200) {number(11){11}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.jumlah_tka_rptka]
 * Jumlah Tenaga Kerja Asing (TKA) dalam Rencana Penggunaan Tenaga Kerja Asing (RPTKA)		
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.jangka_penggunaan_waktu]
 * Jangka Waktu Penggunaan Tenaga Kerja Asing (TKA) dalam Izin Rencana Penggunaan Tenaga Kerja Asing (RPTKA) (format date : YYYY- MM-DD)
 * @apiSuccess (200) {number(1){1}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.jangka_waktu_permohonan_rptka]	Jangka Waktu Permohonan RPTKA
 * @apiSuccess (200) {Object[]} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan] Data RPTKA Jabatan		
 * @apiSuccess (200) {number(11){11}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.id_jabatan]
 * ID Jabatan Tenaga Kerja Asing berdasarkan https://jdih.kemnaker.go.id/data_puu/KEP247_MENX_2011.pdf
 * @apiSuccess (200) {string(255){255}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.jabatan] Nama Jabatan
 * @apiSuccess (200) {number(11){11}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.jumlah] Jumlah Orang Yang Memiliki Jabatan
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.tgl_mulai]	Tanggal Mulai Jabatan format date		
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.tgl_selesai]	Tanggal Selesai Jabatan format date : YYYY-MM-DD)		
 * @apiSuccess (200) {string(255){255}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.keterangan] Keterangan
 * @apiSuccess (200) {Object[]} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping] Data RPTKA TKI Pendamping		
 * @apiSuccess (200) {number(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.id_jabatan]	Id Jabatan
 * @apiSuccess (200) {number(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.id_pendamping] Id TKI Pendamping
 * @apiSuccess (200) {string(100){100}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.nama] Nama TKI Pendamping
 * @apiSuccess (200) {string(20){20}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.nik] Nomor NIK TKI Pendamping
 * @apiSuccess (200) {string(255){255}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.jabatan] Nama Jabatan TKI Pendamping
 * @apiSuccess (200) {string(25){25}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.hp]	Nomor HP TKI Pendamping
 * @apiSuccess (200) {string(100){100}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.email] Email TKI Pendampiag
 * @apiSuccess (200) {string(65535){65535}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.foto]
 * Foto TKI Pendamping Attachment File dalam Bentukbentuk base64 dengan format (data:image/jpeg;base64,string() ENCODE IMAGE)
 * @apiSuccess (200) {string(50){50}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.pendidikan_min]
 * Tingkat Pendidikan Minimal TKI Pendamping
 * @apiSuccess (200) {string(255){255}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.sertifikat]
 * Sertifikat Kompetensi TKI Pendamping
 * @apiSuccess (200) {number(11){11}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.pengalaman_kerja]
 * Pengalaman Kerja TKI Pendamping (dalam tahun)
 * @apiSuccess (200) {string(255){255}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_jabatan.rptka_tki_pendamping.keterangan]	Keterangan
 * @apiSuccess (200) {Object[]} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_negara] Data RPTKA Negara		
 * @apiSuccess (200) {string(2){2}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_negara.id_negara]	Negara
 * Asal Tenaga Kerja Asing(* Sumber Kodefikasi Negara Mengikuti Standar Unedifact : http://www.unece.org/cefact/loco de/service/location )
 * @apiSuccess (200) {number(11){11}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_negara.jumlah]
 * Jumlah Tenaga Kerja Asing (TKA) dalam Rencana Penggunaan Tenaga Kerja Asing (RPTKA)
 * @apiSuccess (200) {Object[]} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_lokasi] Data RPTKA Lokasi		
 * @apiSuccess (200) {string(10){10}} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_lokasi.lokasi_id]
 * ID Daerah Penanggung Jawab (* Menggunakan Kodefikasi yang diterbitkan oleh Kemendagri - Permendagri No 72
 * Tahun 2019 : https://www.kemendagri.go.id/files/2020/PMDN 72 TH 2019+lampiran.pdf)		
 * @apiSuccess (200) {number(11)} [responfetchNIB.dataNIB.data_perusahaan.data_rptka.rptka_lokasi.jumlah]
 * Jumlah Tenaga Kerja Asing (TKA) dalam Rencana Penggunaan Tenaga Kerja Asing (RPTKA)		
