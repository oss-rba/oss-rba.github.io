 ...
 * @apiSuccess (200) {string(2){2}} responfetchNIB.dataNIB.data_penanggung_jawab.jns_identitas_penanggung_jwb Jenis idetitas penanggung jawab
 * @apiSuccess (200) {string(100){100}} responfetchNIB.dataNIB.data_penanggung_jawab.no_identitas_penanggung_jwb Nomor Identitas Penanggung Jawab
 * @apiSuccess (200) {string(500){500}} responfetchNIB.dataNIB.data_penanggung_jawab.nama_penanggung_jwb Nama Penanggung Jawab
 * @apiSuccess (200) {string(250){250}} responfetchNIB.dataNIB.data_penanggung_jawab.jabatan_penanggung_jwb Jabatan Penanggung Jawab
 * @apiSuccess (200) {string(2){2}} responfetchNIB.dataNIB.data_penanggung_jawab.negara_asal_penanggung_jwb Negara Asal Penanggung Jawab		
 * @apiSuccess (200) {string(15){15}} responfetchNIB.dataNIB.data_penanggung_jawab.npwp_penanggung_jwb NPWP Penanggung Jawab		
 * @apiSuccess (200) {string(1024){1024}} responfetchNIB.dataNIB.data_penanggung_jawab.alamat_penanggung_jwb	Alamat Penanggung Jawab
